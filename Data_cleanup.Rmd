...
Make sure only organisms in the bacterial kingdom are present, and exclude any chloroplast, or mitochondria from analysis.310 ASVs as chloroplast, 465 as mitochondria, and 96 ASVs are eukarya or archaea. We also determined that the genus Cellulosimicrobium is a contaminant so we will exclude the 132 taxa classified as Cellulosimicrobium. We will exclude a total of 1003 taxa. 
```{r unwanted_taxa}
